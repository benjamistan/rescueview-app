...
function InfoCard() {
  return (
    <Card
      className={
        'h-full w-full border-zinc-200 p-0 dark:border-zinc-800 sm:overflow-auto text-black'
      }
    >
      <div className="overflow-x-auto">
        <Table className="w-full">
          ...
          <TableBody>
            {tableDataUserReports.map((item, index) => (
              <TableRow key={index}>
